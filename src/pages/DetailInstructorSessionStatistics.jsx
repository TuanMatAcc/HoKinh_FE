...
const UserSessionStatisticsDetailPage = ({user, facilityMap, classMap, setView, setSelectedUser, setIsChildComponent}) => {
...
export default UserSessionStatisticsDetailPage;
