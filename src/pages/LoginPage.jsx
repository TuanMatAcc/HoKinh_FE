  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      if(err.code === 'ECONNABORTED') {
        message = 'Hệ thống có thể đang bị quá tải, vui lòng thử lại';
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 sm:p-10 relative overflow-hidden border-2 border-gray-100">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600">
              {showForgotPassword ? 'Nhập email để khôi phục mật khẩu' : 'Chào mừng trở lại với Hổ Kình Taekwondo'}
            </p>
          </div>
          ...
          {!showForgotPassword ? (
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                ...
                {(authenticatingState === FAIL) && (
                  <span className='text-red-500 text-sm'>Tài khoản hoặc mật khẩu không chính xác</span>
                )}
              </div>
              ...
              {authenticatingState === WAIT && (
                <div className="bg-blue-50 border border-blue-200 rounded-xl p-4">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-blue-700 font-medium">Đang xác thực...</span>
                  </div>
                </div>
              )}
            ...
            <div className="space-y-6">
              <div className="space-y-2">
                <label htmlFor="reset-email" className="block text-sm font-semibold text-gray-700">Tên đăng nhập</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-5 h-5 text-gray-400">
                      <path strokeLinecap="round" strokeLinejoin="round" d="M21.75 6.75v10.5a2.25 2.25 0 01-2.25 2.25h-15a2.25 2.25 0 01-2.25-2.25V6.75m19.5 0A2.25 2.25 0 0019.5 4.5h-15a2.25 2.25 0 00-2.25 2.25m19.5 0v.243a2.25 2.25 0 01-1.07 1.916l-7.5 4.615a2.25 2.25 0 01-2.36 0L3.32 8.91a2.25 2.25 0 01-1.07-1.916V6.75" />
